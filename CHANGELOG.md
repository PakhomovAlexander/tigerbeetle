...
- [#2137](https://github.com/tigerbeetle/tigerbeetle/pull/2137)
  ...
  Ensure a prepare in the WAL is only overwritten if it belongs to a commit-quorum of checkpoints.
...
- [#2141](https://github.com/tigerbeetle/tigerbeetle/pull/2141)
  ...
  Clarify that the order of replicas in `--addresses` is important.
